...
let exponentialMovingAverage = (data, size) => {
...
const smothedMovingAverage = (data, size, times = 1) => {
  dynamicWeightedMovingAverage(data, times / size, 1);
};

// Weighted moving average
const weightedMovingAverage = (data, size) => {
  const length = data.length;
